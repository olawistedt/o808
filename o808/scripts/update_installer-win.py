...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=o808 Demo Installer\n"
      else:
        line="OutputBaseFilename=o808 Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the o808 Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the o808 installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=o808 Demo installer\n"
     else:
       line="SetupWindowTitle=o808 installer\n"
