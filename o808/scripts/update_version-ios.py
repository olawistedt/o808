...
# AUDIOUNIT v3
  ...
  with open(plistpath, 'rb') as f:
    ...
    if config['PLUG_HAS_UI'] == 1:
      ...
      auv3['NSExtension']['NSExtensionAttributes']['AudioComponents'][0]['factoryFunction'] = "IPlugAUViewController_vo808"
      auv3['NSExtension']['NSExtensionMainStoryboard'] = config['BUNDLE_NAME'] + "-iOS-MainInterface"
    else:
      auv3['NSExtension']['NSExtensionPrincipalClass'] = "IPlugAUViewController_vo808"
